...
Username: admin_wheretofind
Password: Admin@123
Access privileges include system monitoring, user account management, and overall administrative control of system operations.
*Hardware Store Owner Account*
Username: storeowner_demo
Password: Store@123
This account allows management of store profiles, product listings, price updates, and reservation approval.
*Customer Account*
Username: customer_demo
Password: Customer@123
This account enables customers to search for products, compare prices, view store locations using Google Maps, and reserve items.



**B. OutSystems Service Studio Credentials**
The following credentials provide access to the OutSystems Service Studio environment, which was used for system development, configuration, and maintenance.
